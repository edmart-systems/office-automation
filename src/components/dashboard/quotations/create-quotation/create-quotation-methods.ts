...
const quotationValidityRange: QuotationTcsItemRange = {
  min: 1,
  max: 365,
};

const quotationGraceDaysRange: QuotationTcsItemRange = {
  min: 1,
  max: 365,
};

const quotationDeliveryDaysRange: QuotationTcsItemRange = {
  min: 1,
  max: 365,
};
...
export const verifyTcs = ({
  ...
  if (
    !edited_validity_days ||
    edited_validity_days > quotationValidityRange.max ||
    edited_validity_days < quotationValidityRange.min
  ) {
    errArr.push({
  ...
  if (
    !edited_delivery_days ||
    edited_delivery_days > quotationDeliveryDaysRange.max ||
    edited_delivery_days < quotationDeliveryDaysRange.min
  ) {
    errArr.push({
  ...
  if (quotationType.type_id == 1) {
    ...
    if (
      !edited_payment_grace_days ||
      edited_payment_grace_days > quotationGraceDaysRange.max ||
      edited_payment_grace_days < quotationGraceDaysRange.min
    ) {
      errArr.push({
